...
# # 猪肉
# pigDate = PigData("猪肉")
# pr(analysis.change_rate_day(pigDate.get_data(), cycle_index), pigDate.name)
#
# # 鸡蛋
...
#
# 黄金
pr(analysis.change_rate_day(mofComData.get_data('281'), cycle_index), mofComData.get_product_name('281'))

# 铝
pr(analysis.change_rate_day(mofComData.get_data('314'), cycle_index), mofComData.get_product_name('314'))

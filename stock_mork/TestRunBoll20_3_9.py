...
base = BaseStock("base")
mork_ball = MorkBollBackDownLine(20, -3, 9, 5, 999)
...
with open(IndexConstants.date_file_path + "20_3_9_60.txt", 'at') as file:
    ...
    statistics_data["winTime"], statistics_data["winMoney"], statistics_data["down5LineTime"],
    statistics_data["down5LineMoney"], statistics_data["lostTime"], statistics_data["lostMoney"],
    statistics_data["otherTime"], statistics_data["otherMoney"]))
